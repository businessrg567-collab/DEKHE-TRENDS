            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
                  Stay ahead of the competition with data-driven trend insights tailored for the {cityName} market. We help brands identify opportunities before they go mainstream.
                </p>
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-6xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground text-center mb-16 max-w-3xl mx-auto">
                Comprehensive trend intelligence and market research solutions designed for businesses operating in {cityName}.
              </p>
                ...
                {[
                  {
                    ...
                    description: `Monthly trend intelligence reports specific to the ${cityName} market, identifying micro-trends before they go mainstream.`
                  },
                  {
                    icon: BarChart3,
                    title: "Competitor Intelligence",
                    description: `Deep analysis of your competitors in ${cityName}, tracking their strategies, campaigns, and market positioning.`
                  },
                  {
                    icon: Target,
                    title: "Market Research",
                    description: `Comprehensive market research for ${cityName}, including consumer behavior analysis and demand forecasting.`
                  },
                  {
                    icon: Building2,
                    title: "Brand Strategy",
                    description: `Strategic brand positioning and messaging tailored for the ${cityName} audience and market dynamics.`
                  },
                  {
                    icon: Users,
                    title: "Consumer Insights",
                    description: `Deep understanding of ${cityName} consumer preferences, behaviors, and emerging needs.`
                  },
                  {
                    icon: Zap,
                    title: "Growth Strategy",
                    description: `Data-driven growth strategies to scale your business in the competitive ${cityName} market.`
                  }
                ].map((service, index) => (
                  <motion.div
                    key={index}
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                {[
                  `Deep understanding of ${cityName}'s unique market dynamics and consumer behavior`,
                  "Data-driven insights backed by AI-powered trend detection technology",
                  "Industry-specific expertise across fashion, beauty, tech, and D2C sectors",
                  "Proven track record of helping brands stay 6+ months ahead of competition",
                  "Local market knowledge combined with global trend intelligence",
                  "Dedicated analyst support and actionable recommendations"
                ].map((point, index) => (
                  <motion.div
                    key={index}
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="flex items-start gap-4 p-4 rounded-xl bg-card/50 border border-accent/20"
                  >
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-primary/20 to-accent/20 rounded-3xl p-12 border border-primary/30">
              <h2 className="text-4xl md:text-5xl font-bold font-display mb-6">
                Ready to Lead the {cityName} Market?
              </h2>
              <p className="text-xl text-muted-foreground mb-8">
                Get a free trend audit and discover opportunities you're currently missing in {cityName}.
              </p>
              <Link href="/audit">
